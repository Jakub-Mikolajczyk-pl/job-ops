...
import { YourMovePage } from "./pages/YourMovePage";
          ...
          >
            <div ref={nodeRef}>
              <Routes location={location}>
                ...
                <Route path="/your-move" element={<YourMovePage />} />
                <Route
